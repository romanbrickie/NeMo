...
nemo() {
  ...
  pip install --no-deps --no-cache-dir "cut-cross-entropy @ git+https://github.com/apple/ml-cross-entropy.git@eef8c65a81199e6da9098e4951ef5a7cb672ace5; (platform_machine == 'x86_64' and platform_system != 'Darwin')"
