...
coverage run --branch -a --data-file=/workspace/.coverage --source=/workspace/nemo scripts/llm/ptq.py -nc /tmp/nemo2_ckpt -algo block_fp8 -out /tmp/nemo2_ptq_ckpt --export_format nemo --legacy_ckpt
